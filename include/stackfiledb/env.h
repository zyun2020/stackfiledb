...
#ifndef STACKFILE_DB_INCLUDE_ENV_H_
#define STACKFILE_DB_INCLUDE_ENV_H_
...
class STACKFILEDB_EXPORT Env {
 public:
  ...
  virtual Status NewRandomAccessFile(const std::string& fname,
                                     RandomAccessFile** result, bool use_mmap = true) = 0;
  ...
  virtual Status TruncateFile(const std::string& fname, uint64_t file_size) = 0;
...
class STACKFILEDB_EXPORT SequentialFile {
 public:
...
class STACKFILEDB_EXPORT RandomAccessFile {
 public:
  ...
  virtual bool IsMmap() const = 0;
};

// A file abstraction for sequential writing.  The implementation
// must provide buffering since callers may append small fragments
// at a time to the file.
class STACKFILEDB_EXPORT WritableFile {
 public:
...
class STACKFILEDB_EXPORT Logger {
 public:
  Logger() = default;
...
class STACKFILEDB_EXPORT FileLock {
 public:
  FileLock() = default;
...
STACKFILEDB_EXPORT Status WriteStringToFile(Env* env, const Slice& data,
                                        const std::string& fname);

// A utility routine: read contents of named file into *data
STACKFILEDB_EXPORT Status ReadFileToString(Env* env, const std::string& fname,
                                       std::string* data);

// An implementation of Env that forwards all calls to another Env.
// May be useful to clients who wish to override just part of the
// functionality of another Env.
class STACKFILEDB_EXPORT EnvWrapper : public Env {
 public:
  ...
  Status NewRandomAccessFile(const std::string& f,
                             RandomAccessFile** r, bool use_mmap = true) override {
  ...
  Status TruncateFile(const std::string& f, uint64_t s) override {
      return target_->TruncateFile(f, s);
  }
...
#endif  // STACKFILE_DB_INCLUDE_ENV_H_
